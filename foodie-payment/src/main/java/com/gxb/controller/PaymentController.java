...
import com.gxb.pojo.bo.MerchantOrdersBO;
import com.gxb.pojo.vo.PaymentInfoVO;
import com.gxb.resource.AliPayResource;
import com.gxb.resource.WXPayResource;
import com.gxb.service.PaymentOrderService;
import com.gxb.utils.CurrencyUtils;
import com.gxb.utils.JSONResult;
import com.gxb.utils.PaymentStatus;
import com.gxb.utils.RedisOperator;
import com.gxb.wx.entity.PreOrderResult;
import com.gxb.wx.service.WxOrderService;
...
//	@GetMapping(value="/getWXPayQRCode")
	...
	public JSONResult goAlipay(String merchantOrderId, String merchantUserId) {
